...
const CreateCourse = () => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axiosInstance.put('/updateCourse', { courseName, courseLink, courseDescription, coursePrice, popUpText });
                                        ...
                                        <div className="card-body">
                                            ...
                                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-4">
                                                        <div className="mb-3">
                                                            <label className="form-label">Course POpUp</label>
                                                            <input
