                                ...
                                <div className="col-md-6 col-xl-4">
                                    <div className="card mb-3 widget-content bg-night-fade">
                                        <div className="widget-content-wrapper text-white">
                                            ...
                                            <div className="widget-content-right">
                                                <div className="widget-numbers text-white"><span style={{margin : "70px"}}>{principal}</span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="card mb-5">
                                        <div className="card-body">
                                                ...
                                                <table className="table">
                                                    ...
                                                    <tbody key={row._id}>
                                                        <tr>
                                                            ...
                                                            <td className="tableCustomar">{row.courseDescription}</td>
                                            ...
                                            <div className="text-end">
                                                <a href="/DashBoardCourse" className="btn btn-primary bgBlue btn-dipBlue px-3">
                                                    View All Courses
                                                </a>
                                            </div>
                                        </div>
