...
<div className='col-9'>
          <Tabs value={tabIndex} onChange={handleTabChange} aria-label="course details tabs">
            ...
            <Tab label="Announcement" style={{ fontWeight: 700 }} />
    ...
    <div class="announcement-card card">
        <div class="card-header">
            <div class="author mt-4">
                ...
                <div>
                    <strong>Santosh Kumar</strong><br/>
                    <small class="text-muted">posted an announcement · 1 year ago</small>
                </div>
            </div>
        </div>
        <div class="card-body">
            <h5 class="card-title">New Course: Advanced React Techniques</h5>
            <p class="card-text">Hello everyone, we're excited to announce our new course on Advanced React Techniques. This course covers hooks, context API, and performance optimization. Enroll now to enhance your React skills!</p>
    ...
    <div class="announcement-card card">
        <div class="card-header">
            <div class="author mt-4">
                <img src="https://via.placeholder.com/40" alt="Author"/>
                <div>
                    <strong>Mayank Sir</strong><br/>
                    <small class="text-muted">posted an announcement · 6 months ago</small>
                </div>
            </div>
        </div>
        <div class="card-body">
            <h5 class="card-title">Web Development Bootcamp</h5>
            <p class="card-text">Join our comprehensive Web Development Bootcamp designed for beginners and intermediates. Learn HTML, CSS, JavaScript, and more to kickstart your career in web development.</p>
    ...
    <div class="announcement-card card">
        <div class="card-header">
            <div class="author">
                ...
                <div className='mt-4'>
                    <strong>Santosh Kumar</strong><br/>
                    <small class="text-muted">posted an announcement · 3 months ago</small>
                </div>
            </div>
        </div>
        <div class="card-body">
            <h5 class="card-title">Data Science with Python</h5>
            <p class="card-text">Our new Data Science with Python course is now live! Learn the fundamentals of data analysis, visualization, and machine learning using Python. Perfect for aspiring data scientists.</p>
        ...
        <div class="card-header">
            <div class="author mt-4">
                ...
                <div>
                    ...
                    <small class="text-muted">posted an announcement · 2 months ago</small>
                </div>
            </div>
        </div>
        <div class="card-body">
            <h5 class="card-title">Mastering Machine Learning</h5>
            <p class="card-text">Dive deep into the world of machine learning with our new course. From basic algorithms to advanced techniques, this course covers everything you need to become a machine learning expert.</p>
