...
const Sidebar = ({ onFileClick, onCodeSelect }) => {
  ...
  // Determine box width and height based on screen size
  const boxWidth = useBreakpointValue({ base: "100%", md: "100%" });
  const boxHeight = useBreakpointValue({ base: "100%", md: "95vh" });
  ...
  return (
    <>
      ...
      <Box className="box-fix" w={boxWidth} p={4} height={boxHeight} overflowY="auto">
