...
const CourseInfo = () => {
  ...
  AI and LMS for children's education,
  Online AI courses for children,
  Adaptive learning platforms for kids,
  AI-enhanced study programs for kids,
  Digital education tools for children,
  Interactive AI courses for kids,
  Personalized learning systems for children
"/>
