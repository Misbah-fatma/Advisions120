// StudentList.js (Your all students table component)
import React, { useEffect, useState } from "react";
import Sidebar from '../SideBar';
import axios from "axios";
import StudentDetailModal from './StudentsDetails'; // Import the modal component
...
const Student  = () => {
  ...
  return (
    <div>
                          ...
                          <tbody>
                            {(rowsPerPage > 0
                              ...
                              <tr key={row._id}>
                                ...
                                <td className="tableId"><span></span> {row.role}</td>
                                ...
                                <td className="tableAction">
                                  <div className="action-icon">
                                    ...
                                    <a data-bs-toggle="tooltip" data-bs-placement="top"
                                      ...
                                      onClick={() => handleDeleteUser(row._id)}><i
                                        className="bi bi-trash3 Circleicon"></i></a>
                                    <a href="#" onClick={() => handleShow(row)}>Details</a> {/* Add the Details link */}
                                  </div>
                                </td>
                              </tr>
                            ))}
      ...
      {/* Render the StudentDetailModal component */}
      {selectedStudent && (
        <StudentDetailModal
          show={show}
